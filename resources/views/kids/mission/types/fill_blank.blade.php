<!-- THIS IS EXACTLY THE SAME AS MULTIPLE CHOICE BECAUSE THE LAYOUT IS IDENTICAL -->
<template x-if="currentQuestion.type === 'fill_blank'">
    <div style="width:100%; display:flex; justify-content:center;">
        
        <!-- SQUARE LAYOUT (No options have images, they are just letters) -->
            ...
            <div class="layout-square">
                <template x-for="(option, i) in currentQuestion.options" :key="option.id">
                    <div class="square-btn"
                        ...
                        <span x-text="option.text" style="font-size: 42px; font-weight: 900;"></span>
        ...
        <!-- VERTICAL LAYOUT FALLBACK (Just in case they add images to fill_blank later) -->
        <template x-if="currentQuestion.options.some(o => o.image)">
