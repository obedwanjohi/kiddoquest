...
// Direct Standalone Execution script: expands all 965 CSV files across 9 subjects to 20 questions each.
...
foreach ($subjects as $folder => $info) {
    ...
    echo "Processing {$folder}: " . count($files) . " CSV files...\n";
...
echo "SUCCESS! Total Checked: {$totalChecked} | Total Expanded to 20 Questions: {$totalFixed}\n";
