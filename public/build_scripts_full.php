...
function get_all_missions($dir_path) {
...
$missions = get_all_missions($base_dir . "database/csv_imports/pp2_math");
...
$missions = get_all_missions($base_dir . "database/csv_imports/pp2_english");
...
$missions = get_all_missions($base_dir . "database/csv_imports/pp2_cre");
...
$missions = get_all_missions($base_dir . "database/csv_imports/pp1_math");
...
$missions = get_all_missions($base_dir . "database/csv_imports/pp1_english");
...
$missions = get_all_missions($base_dir . "database/csv_imports/pp1_cre");
...
$missions = get_all_missions($base_dir . "database/csv_imports/play_group_math");
...
$missions = get_all_missions($base_dir . "database/csv_imports/play_group_english");
...
$missions = get_all_missions($base_dir . "database/csv_imports/play_group_cre");
...
echo "SUCCESS: ALL 825 INDIVIDUAL MISSION SCRIPT SECTIONS WRITTEN IN FULL!";
